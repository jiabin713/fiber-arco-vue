<template>
  <div class="login-form-wrapper">
    ...
    <a-form ref="formRef" :model="formModel" :rules="Rules" class="login-form" layout="vertical" @submit="handleSubmit">
      <a-form-item field="username" :validate-trigger="['change', 'blur']" hide-label>
        <a-input v-model="formModel.username" allow-clear>
          <template #prefix>
            <icon-user />
          </template>
        </a-input>
      ...
      <a-form-item field="password" :validate-trigger="['change', 'blur']" hide-label>
        <a-input-password v-model="formModel.password" allow-clear>
          <template #prefix>
            <icon-lock />
          </template>
        </a-input-password>
      ...
      <a-space :size="16" direction="vertical">
        <div class="login-form-password-actions">
          <a-checkbox checked="rememberPassword" v-model="formModel.remember">
